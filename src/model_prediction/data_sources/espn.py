...
LEAGUE_PATHS: dict[str, str] = {
    ...
    "BELGIAN_PRO": "soccer/bel.1",
    "TURKISH_SUPER": "soccer/tur.1",
    "SAUDI_PRO": "soccer/ksa.1",
    "GREEK_SUPER": "soccer/gre.1",
    "SWISS_SUPER": "soccer/sui.1",
    "A_LEAGUE": "soccer/aus.1",
    "J_LEAGUE": "soccer/jpn.1",
    "2_BUNDESLIGA": "soccer/ger.2",
    "LA_LIGA_2": "soccer/esp.2",
    "SERIE_B": "soccer/ita.2",
    "LIGUE_2": "soccer/fra.2",
    "LIBERTADORES": "soccer/conmebol.libertadores",
    "FA_CUP": "soccer/eng.fa",
    ...
    "ROMANIAN_LIGA_1": "soccer/rou.1",
    "CZECH_FIRST": "soccer/cze.1",
    "PARAGUAY_PRIMERA": "soccer/par.1",
    "BOLIVIA_PRIMERA": "soccer/bol.1",
    "VENEZUELA_PRIMERA": "soccer/ven.1",
    "USL_CHAMPIONSHIP": "soccer/usa.usl.1",
    "LIGA_EXPANSION_MX": "soccer/mex.2",
    "EFL_TROPHY": "soccer/eng.trophy",
    ...
    "COPA_AMERICA": "soccer/conmebol.america",
    "AFCON": "soccer/caf.nations",
    "ASIAN_CUP": "soccer/afc.asian.cup",
    "NCAAB": "basketball/mens-college-basketball",
    "WNCAAB": "basketball/womens-college-basketball",
    "NHL": "hockey/nhl",
    "MENS_COLLEGE_HOCKEY": "hockey/mens-college-hockey",
    "CFL": "football/cfl",
    "UFL": "football/ufl",
...
SPORT_LEAGUES: dict[str, tuple[str, ...]] = {
    ...
    "cfl": ("CFL",),
    "ufl": ("UFL",),
    # One key's league set appends into ONE processed/<sport>/games.jsonl
    # (ingest._append_games), so a sibling league is not extra coverage -- it
    # mixes another competition's games into the dataset every Elo, trend and
    # walk-forward feature reads for this sport. College hockey is not NHL
    # history. Settlement coverage for those leagues comes from cli/state.py's
    # _LEDGER_LEAGUE_TO_ESPN, which resolves results without writing into a
    # sport's training data. This is what made 5 ingest tests red on 2026-08-30
    # when MLB briefly gained COLLEGE_BASEBALL the same way.
    "hockey": ("NHL",),
    "soccer": (
        "EPL",
        "LA_LIGA",
