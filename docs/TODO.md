...
- [x] **Title-Specific Esports Engines (`esports_cs2.py`, `esports_lol.py`, `esports_valorant.py`)**: CS2 map veto and pistol round momentum (+2.15 rounds); LoL Blue side first-pick bias (+3.5%) and GD@15 objective control; Valorant map pools and agent economy. → DONE: `CS2VetoEngine`, `LoLEngine`, `ValorantVetoEngine` & tests.
