...
| [`TODO.md`](TODO.md) | **Active Task Queue**: P0–P3 prioritized repair list and quantitative feature roadmap. | Planning next development & research tasks |
...
| [`ENGINEERING_ROADMAP.md`](ENGINEERING_ROADMAP.md) | Infrastructure roadmap, technical debt retirement, and package modularization plans. |
...
| [`V9_RESEARCH_PLAN.md`](V9_RESEARCH_PLAN.md) | MLB v9 research plan (lineup capture, reliever workload, starter depth). |
| [`RESEARCH_BACKLOG.md`](RESEARCH_BACKLOG.md) | Prioritized queue of quantitative hypotheses, experimental designs, and backtests. |
