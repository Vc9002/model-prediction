...
**Session 2026-08-22 — Flat vs Gated Ledger Invariants & Gated Quality Controls**:
...
- **Gated Fixes Implemented**:
  ...
  3. **Dashboard Unarchived Counts**: Excluded archived pre-change records from Flat, Research, and Gated badge counters.
