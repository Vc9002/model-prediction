...
def test_validation_is_chronological_versioned_and_never_promotes_baseline(tmp_path) -> None:
    ...
    artifact = json.loads((tmp_path / "artifacts/lol-neutral-series-elo-v1.json").read_text())
...
def test_forecast_requires_exact_identity_and_remains_zero_unit(tmp_path) -> None:
    ...
    (artifacts / "lol-neutral-series-elo-v1.json").write_text(
        json.dumps(
            {
                "model_version": "lol-neutral-series-elo-v1",
