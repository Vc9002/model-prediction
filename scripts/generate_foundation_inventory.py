...
def main() -> None:
    ...
    # fabricated SUCCESS); KBO/NPB are registered too, as an explicit
    # research_only decision (CLAUDE.md: "restrict the model rather than
    # inventing MLB-equivalent features") rather than left to a bare
    # ValueError -- no real collector or data source client exists for
